...
import { Film, Plus, Pencil, Trash2, LogOut, ArrowLeft, Link, ImageIcon } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-10 max-w-4xl">
        ...
        <div className="bg-card rounded-lg border border-border p-6 mb-10 animate-fade-in shadow-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            />
            <Textarea
              placeholder="Descripción (sinopsis, año, género...)"
            ...
            <div className="relative">
              ...
              <Input
                placeholder="URL del video: YouTube, Google Drive, Vimeo, enlace directo... *"
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-sm text-muted-foreground tabular-nums">
              {peliculas.length} {peliculas.length === 1 ? "entrada" : "entradas"}
            </span>
          </div>
          ...
          <div className="space-y-3">
            {peliculas.map((p, i) => (
              <div
                key={p.id}
                className="bg-card rounded-lg border border-border p-4 flex items-center gap-4 animate-fade-in hover:border-border/80 transition-colors"
              ...
              >
                <div className="shrink-0 w-12 h-18">
                  {p.portada_url ? (
                    <img
                      src={p.portada_url}
                      alt={p.titulo}
                      className="w-12 h-[4.5rem] object-cover rounded border border-border/50"
                      loading="lazy"
                    />
                  ) : (
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {p.descripcion && (
                    <p className="text-sm text-muted-foreground truncate mt-0.5">{p.descripcion}</p>
                  )}
